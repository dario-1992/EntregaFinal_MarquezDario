...
def login_request(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                login(request, user)
                return render(request, "Registro/index.html", {"mensaje" : f"Bienvenido/a {usuario}"})
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return render(request,"Registro/index.html",{"mensaje" : f"Registro exitoso"})
...
def editar_perfil(request):
    ...
    return render(request, "user/editar_perfil.html", {"mi_form": miFormulario, "usuario": usuario})
